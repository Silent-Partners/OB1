...
export function ThoughtsFilter({
  ...
  return (
    <div className="flex flex-wrap items-end gap-4 bg-bg-surface border border-border rounded-sm p-4">
      <div>
      ...
      <div>
        ...
        <input
          ...
          className="bg-bg-elevated border border-border rounded-sm px-3 py-2 text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-violet w-44"
        />
      </div>
